python3 train_net.py --config-file="../configs/tuo/e2e_faster_rcnn_R_50_FPN_1x.yaml" OUTPUT_DIR ./checkpoint/deform_128
python3 train_net.py --config-file="../configs/tuo/e2e_faster_rcnn_R_50_FPN_1x.yaml" OUTPUT_DIR ./checkpoint/fpn_128
